...
\begin{figure}[H]
  ...
  \caption{\small Histogram of token incidence in the logarithmic scale: (a) all tokens, (b) tokens which are not a stopwords, \url s or punctuations. The Pareto trace can be noticed by the descending line in the log x log plot. Noteworthy is that theory predicts histogram (b) to exhibit a line in the logarithmic scale, but histogram (a) follows predictions more closely.}\label{fig:tH}
\end{figure}
