...
Lalenia bot & \python & \irc\ & any &\cite{lalenia} & \#labmacambira@Freenode \irc\ channel \\\hline
Ubiquitous \aab & \python & \irc, \twitter, \gchat, \facebook, email, \msn & any & \url{ubi} & -//- \\\hline
  \end{tabular}
\end{table}
