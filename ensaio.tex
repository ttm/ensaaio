...
\begin{figure}[H]
  ...
  \caption{\small Histogram of incident and existent token size. Top histogram considers all tokens. Middle histogram considers tokens which are not punctuations, \url s or stopwords (Portuguese and English). Bottom histogram considers all radicals from tokens used for middle histogram.}\label{fig:dH}
\end{figure}
