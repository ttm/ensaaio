...
Distinct use methods are incident (Section~\ref{sec:sp}).
\subsection{Words and tags}\label{sec:sp}
\subsection{Shouts}\label{sec:sp}
\subsection{Sessions}\label{sec:sp}
\subsection{Developments}\label{sec:sp}
\subsection{Suplimentary commands}\label{sec:sp}
